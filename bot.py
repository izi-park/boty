...
def get_answer(text):
    ...
    if "подключение" in text:
        return (
            ...
            "📌 Если уже есть самозанятость и вы зашли в Яндекс Про через наш парк, "
            "нажмите в меню «Самозанятость / ИП» и заполните анкету.\n"
            "Если вы ещё не прошли регистрацию в парке, но аккаунт Яндекс Про уже есть — "
            "заполните форму:\n"
